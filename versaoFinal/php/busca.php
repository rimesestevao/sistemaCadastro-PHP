...
<body>
    ...
    <div class="cardResultado row align-items-center justify-content-between">
        <div class="divPHP col-6" >
            <?php
                include 'conexao.php';
        ...
        <div class="divForm col-6">
            <div class="row">
                <form class="col-6"  autocomplete="off" method="POST" action="editForm.php">
                ...
                <form class="col-6"  autocomplete="off" method="POST" action="delete.php">
